...
foldersList = c("s3://fresh-vs-frozen-comparison/BI5/snrna-seq",
  "s3://fresh-vs-frozen-comparison/cpoi-uvealprimarydata",
  "s3://fresh-vs-frozen-comparison/nsclc")

patsList = list(c("bi005-skcm-5snseq","bi005-skcm","skcm-bi005-5pv2-snseq"),
  c("UMEL-CUUM1-SCRNA-5P-NA-PRIMARY-GEX-F1","UMEL-CUUM1-SNRNA-5P-WI-PRIMARY-GEX-F12"),
  c("NSCL_NR001_SNSEQ_3P_WI_BRAIN_GEX","NSCL_NR001_SNSEQ_5P_NI_BRAIN_GEX","NSCL-NR001-5pv2-snseq"))

maxCountsList = list(c(20000,25000),
  c(7500,30000,15000))
maxFeaturesList = list(c(7500,7000,5000),
  c(4500,6000),
  c(4000,7000,6000))
